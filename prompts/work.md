...
1. Call `next_task`, saying who you are. It claims the next task and returns
   its full instructions — the playbook for that kind of task with the task's
   own parameters on top. If it says the queue is empty, stop and report.
